...
/* The above code is defining an array named `apiList` which contains configurations for different APIs related to
healthcare data. Each object in the array represents a specific API such as Patient, Encounter, Practitioner,
